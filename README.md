# Homework 2 - *QuickChat*

**QuickChat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **NhiepPhong**

Time spent: **20** hours

URL: **https://quickchatio.herokuapp.com/**
